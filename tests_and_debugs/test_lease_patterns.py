...
print(f"Estimated Price: {result.get('estimated_price')}만원")
print(f"True Price: {result.get('total_cost')}만원")
print(f"Final Payment: {result.get('final_payment')}만원")
...
print("Final Payment: 23.01만원")
print("Total Cost: 83.92만원 (18.01 + 1.65*26 + 23.01)")
print("Is Lease: True") 